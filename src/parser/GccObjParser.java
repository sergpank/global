...
public class GccObjParser
    ...
    public String getGlobalVariableName(String line) {
        ...
        if (line.contains(" B ") || line.contains(" D ")) {
            ...
            if (!(possibleGV.startsWith("__Z"))) {
                if (possibleGV.startsWith("?")) {
                    if( ! ( possibleGV.startsWith("??") || possibleGV.indexOf("@") == possibleGV.indexOf("@?$") ) ){
                        result = possibleGV.substring(1, possibleGV.indexOf("@@"));
                    }
                } else {
